...
<head>
  ...
  <!-- JQVMap -->
  <link rel="stylesheet" href="{{asset('backend/assets/plugins/jqvmap/jqvmap.min.css')}}" rel="stylesheet">
  <!-- Theme style -->
  <link  href="{{asset('backend/assets/dist/css/adminlte.min.css')}}" rel="stylesheet" rel="stylesheet">
  <!-- overlayScrollbars -->
 ...
 <!-- Main Sidebar Container -->
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('backend/assets/dist/img/apple.png')}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
