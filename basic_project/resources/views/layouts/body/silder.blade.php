<section id="main-slider" class="no-margin">
    <div class="carousel slide">
        ...
        <div class="carousel-inner">
            ...
            <div class="item active" style="background-image: url({{asset('frontend/assets/images/slider/bg1.jpg')}})">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
            ...
            <div class="item" style="background-image: url({{asset('frontend/assets/images/slider/bg2.jpg')}})">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <div class="carousel-content">
